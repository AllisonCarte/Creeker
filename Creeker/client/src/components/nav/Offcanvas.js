...
const Canvas = (args) => {
    ...
    return (
      <div style={{display: "flex", flexWrap: "nowrap",  justifyContent: "end"}} >
        <Button
          style={{marginRight: "10px", marginTop: "10px", backgroundColor: "#587D71"}}
          onClick={() => {
            setOpen(true);
          }}
        >
        ...
        <Offcanvas style={{width: "200px", backgroundColor: "#587D71"}} {...args} isOpen={open} toggle={toggle}>
          <OffcanvasHeader style={{color: "#EEFBF5"}} toggle={toggle}>Category Options</OffcanvasHeader>
